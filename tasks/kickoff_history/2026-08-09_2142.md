...
Written 2026-08-09 21:42 BST. Normal-mode handoff.
`mode: normal` · `canonical_kickoff_updated: true`

Archived copy. The live continuation is `tasks/next_session_kickoff.md`.
...
apart from `reference/`. It is **not** part of DrinkSmart. (Corrected shortly after archiving: it became a git repository at `2fc36b1`, with a remote. Do not push there — Oscar pushes.) Do
