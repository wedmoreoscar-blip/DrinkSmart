...
secrets. Run tools/check-agent-setup. Verify the repo-local instructions, skills, and custom agents are
discoverable. Then inspect, but do not overwrite, any same-name user-level skills. Ask for approval
